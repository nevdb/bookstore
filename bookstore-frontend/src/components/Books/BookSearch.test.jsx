import { describe, it, expect, beforeEach, vi } from "vitest";import React from 'react';import { render, screen, fireEvent, waitFor } from "@testing-library/react";
...
describe("BookSearch Component", () => {
  ...
  it("renders search form with input field", () => {
    ...
    const input = screen.getByPlaceholderText(
      /search by title, author, or genre/i,
    );
