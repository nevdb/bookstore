...
describe('BookFilter Component', () => {
  ...
  it('calls filterBooks when genre is selected', async () => {
    ...
    await waitFor(() => {
      expect(mockFilterBooks).toHaveBeenCalledWith({ genre_id: '1' });
    });
  });
  ...
  it('calls filterBooks when author is selected', async () => {
    ...
    await waitFor(() => {
      expect(mockFilterBooks).toHaveBeenCalledWith({ author_id: '2' });
    });
  });
    ...
    mockGetBooks.mockReturnValue(
      new Promise(resolve => setTimeout(() => {
        resolve({
          data: {
            data: [
              { id: 1, genre: { id: 1, name: 'Fiction' }, author: { id: 1, name: 'Author 1' } },
            ],
          },
        });
      }, 100))
