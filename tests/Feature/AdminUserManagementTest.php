...
class AdminUserManagementTest extends TestCase
{
    ...
    public function test_get_users_pagination_second_page()
    {
        ...
        $this->assertEquals(7, count($response->json('data'))); // 22 total users - 15 on first page = 7 on second
    }
    ...
    public function test_admin_can_get_statistics()
    {
        ...
        $this->assertEquals(22, $response->json('data.total_users'));
        $this->assertEquals(2, $response->json('data.total_admins'));
        $this->assertEquals(20, $response->json('data.total_regular_users'));
    }
